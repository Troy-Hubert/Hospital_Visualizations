...
# Mothership_lasso_dep <- Mothership_post |>
#     filter(
#     !is.na(Some_College),
#     !is.na(Female),
#     !is.na(IPT_track_1),
...
table1_vars_anx <- c(colnames(Vars_anx)[-1])
...
tab1_df_anx <- data.frame(table1_tab_anx)
tab1_df_anx
...
JT_table[1,] = c("CUXOS", unlist(summary(Mothership_lasso$Anxiety_Responder)))
# Depresssion
JT_table[2,] = c("CUDOS", unlist(summary(Mothership_lasso$Depression_Responder)))
