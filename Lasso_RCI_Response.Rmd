...
AnxDep_PrePost <- data.frame(cbind(Mothership_post_joined$ID1,
                                   Mothership_post_joined$Disorder_treat,
                                   Mothership_post_joined$BL_CUDOS,
                                   Mothership_post_joined$BL_CUXOS,
                                   Mothership_post_joined$CUDOS_pre,
                                   Mothership_post_joined$CUDOS_post,
                                   Mothership_post_joined$CUXOS_pre,
                                   Mothership_post_joined$CUXOS_post,
                                   #Extra stuff?
                                   Mothership_post_joined$Depression_Responder,
                                   Mothership_post_joined$Anxiety_Responder
...
# 
# ## Vector of variables to summarize
# table1_vars_gen <- c(colnames(Mothership_lasso_joined)[-1:-3])
...
JT_table[1,] = c("CUXOS", unlist(summary(Mothership_lasso_anx$Anxiety_Responder)))
# Depresssion
JT_table[2,] = c("CUDOS", unlist(summary(Mothership_lasso_dep$Depression_Responder)))
...
## min model
  glm_min_dep <-
      ...
      #Outcome varaible
        Depression_Responder ~
      # predictors
        Some_College  + Married + White +
        Days_not_attended_1 + Mood_C +
        CUDOS_pre + CUXOS_pre + 
...
## min model
  glm_min_anx <-  
      ...
      #Outcome varaible
        Anxiety_Responder ~ 
      # predictors
        Age_1 + Some_College + Married + 
        White +  Days_complete_1 +Days_not_attended_1 + 
        Anxiety_D + Trauma_D + Other + 
...
Anx_reg_coefs[1:10] <- c("Age","Some_College","Married", "White","Days_complete","Days_not_attended", "Anxiety_D", "Trauma_D","Other", "Substance_C")
FP_anx$Variable = Anx_reg_coefs
