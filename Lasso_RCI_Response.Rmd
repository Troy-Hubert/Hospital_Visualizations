...
model <- glmnet(x.dep, y.dep, alpha = 1, family = "binomial",
...
## min model
  glm_min_dep <-
      ...
      #Outcome varaible
        Depression_Responder ~
      # predictors
        Married + Days_not_attended_1 + Mood_D + Substance_D + Anxiety_C +
        Substance_C + CUDOS_pre + CUXOS_pre + rdq_coping_change + 
        rdq_pmh_change + rdq_func_change,
      #data
        data = Vars_dep,
      # type of regression : logistic = binary / binomial
        family = "binomial")
...
## 1se model
  glm_1se_anx <-  
      ...
      #Outcome varaible
        Anxiety_Responder ~ 
      # predictors
         CUXOS_pre + rdq_coping_change + rdq_pmh_change + rdq_func_change,
      #data
      data = Vars_anx, 
      # type of regression : logistic = binary / binomial
      family = "binomial")
