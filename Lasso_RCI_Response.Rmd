...
## min model
  glm_min_anx <-  
      ...
      #Outcome varaible
        Anxiety_Responder ~ 
      # predictors
        Age_1 + Married + Days_complete_1 + Days_not_attended_1 + Anxiety_D + 
        Substance_C + Trauma_D + Other + Mood_C + BPD_Co_C + Substance_C + 
        CUXOS_pre + 
        rdqPOST_coping + rdqPOST_pmh + rdqPOST_func + rdqPOST_wbs,
      #data
      data = Vars_anx, 
...
FP_anx$Variable = c("Age", "Unmarried", "Days Completed", 
                    "Days Not Attended", "Anixety Disorder","Co-SUD", 
                    "Trauma Disorder", "Other Disorder", "Co-Mood Disorder", 
                    "Co-BPD", "CUXOS Pre", "Post Coping", 
