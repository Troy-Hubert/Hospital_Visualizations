...
glm_min_dep <-
  ...
  #     # predictors
  #       Age_1  +
  #       Days_complete_1 + Days_not_attended_1 + Anxiety_D + 
  #       BPD_Co_C + Current_Dx + CUXOS_pre+
  #       rdqPOST_coping + rdqPOST_pmh + rdqPOST_func + rdqPOST_wbs,
  #     #data
  #       data = Vars_dep,
  #     # type of regression : logistic = binary / binomial
...
## min model
  glm_min_anx <-  
      ...
      #Outcome varaible
        Anxiety_Responder ~ 
      # predictors
        Days_complete_1 + Days_not_attended_1 + Anxiety_C + Substance_C + 
        rdqPOST_coping + rdqPOST_pmh + rdqPOST_func + rdqPOST_wbs,
      #data
      data = Vars_anx, 
      # type of regression : logistic = binary / binomial
...
FP_anx$Variable = Anx_reg_coefs2
...
# Anx_reg_coefs[1:8] <- c("Days completed","Days not attended", "Co-Anxiety",         "Co-Substance",        "Post coping" ,     "Post pmh"     ,   
# "Post functioning"   ,     "Post wellbeing" )
