...
str(Mothership_post$Education_1)
...
Mothership <- mutate(Mothership, 
                     ...
                     Married = recode(Relationship_1,
                                             "Married or Cohabitating" = "Married or Cohabitating",
                                             "Widowed or Separated" = "Not",
                                             "Divorced" = "Not",
                                             "Single or Never Married" = "Not"),
                     ...
                     Discharge = recode(DC_status_1,
                                          "Treatment Complete" = "Treatment Successful",
                                          "Treatment nearly complete" = "Treatment Successful",
                                          "Insurance no longer covering" = "Other",
                                          "Nonattendance" = "Other",
                                          "Inappropriate (language)/Referred to another tx setting" ="Other",
                                          "Transferred to inpatient"="Other",
                                          "Withdrew due to external limitations"="Other",
                                          "Withdrew AMA"="Other",
                                          "Other"="Other",
                                          "Other"="Other",
                                          "Other"="Other"),
...
```{r}
cor_tab<- Mothership_post |>
  select( c(
    # Demographics
    Age_1,Some_College:Discharge,
    # Treatment info
    IPT_track_1, Days_complete_1, # Days_noshow_1, Days_not_attended_1, Days_cancel_1,
    # Disorders
    Mood_D:Other,Co_Anx:Co_Trauma,Current_Dx,
    # Pre-Post stuff
    CUDOS_pre,CUXOS_pre, #CUDOS_first,CUXOS_first
    # RDQ
    rdq_coping_change:rdq_sym_change
    
  ))



#comments about what I should do
      #Should I make a level of anxiety / depression - cuxos cut offs?
      # should I use the first score or the pre score?
      # Should I do each individual disorder, or just the overarching classes (i.e., depression)?
      # should I include co_occuring even if there is a lot of overlap (i.e., depressive P and Co)
