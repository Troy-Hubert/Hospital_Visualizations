...
#set path for working directory for PC or MAC
wd_path <- 
  ifelse(Sys.info()[[1]] == "Windows","C:/Users/troyh/OneDrive - University of Kentucky/Coding/R working directory/",
         ifelse(Sys.info()[[1]] == "Darwin", "~/Desktop/Coding/R working directory/","¿¿Donde Estoy??"
         ))

#Set path for directory with data files for PC or MAC
data_path <- 
  ifelse(Sys.info()[[1]] == "Windows","C:/Users/troyh/OneDrive - University of Kentucky/Coding/data/",
         ifelse(Sys.info()[[1]] == "Darwin", "~/Desktop/Coding/Data/","¿¿Donde Estoy??"
         ))

#read main File
Mothership <- read_sav(paste0(data_path,"PHPoutcome_clean.sav"))
...
```{r}
# AAQIIpre <- read_sav("~/Desktop/Coding/data/ACT_scores/AAQIIPre_1.sav")
# AAQIIpre <- AAQIIpre |>
#   mutate(
#     AAQIIpre = AAQIIpre_1_1 + AAQIIpre_2_1 + AAQIIpre_3_1 + AAQIIpre_4_1 + 
#       AAQIIpre_5_1 + AAQIIpre_6_1 + AAQIIpre_7_1
#   )
# Mothership <- left_join(Mothership,AAQIIpre, by = join_by(ID1 == ID1))
# 
# AAQIIpost <- read_sav("~/Desktop/Coding/data/ACT_scores/AAQIIPost_1.sav")
# AAQIIpost <- AAQIIpost |>
#   mutate(
#     AAQIIpost = AAQIIpost_1_1 + AAQIIpost_2_1 + AAQIIpost_3_1 + AAQIIpost_4_1 + 
#       AAQIIpost_5_1 + AAQIIpost_6_1 + AAQIIpost_7_1
#   )
# Mothership <- left_join(Mothership,AAQIIpost, by = join_by(ID1 == ID1))
# 
# FMMQ_pre <- read_sav("~/Desktop/Coding/data/ACT_scores/FFMQPre_1.sav")
# FMMQ_pre <- FMMQ_pre|>
#   mutate(
#     #reverse code items
#     FFMQpre_4R  = 6 - FFMQpre_4_1,
#     FFMQpre_5R  = 6 - FFMQpre_5_1,  
#     FFMQpre_7R  = 6 - FFMQpre_7_1, 
#     FFMQpre_8R  = 6 - FFMQpre_8_1, 
#     FFMQpre_11R = 6 - FFMQpre_11_1, 
#     FFMQpre_12R = 6 - FFMQpre_12_1,
#     FFMQpre_14R = 6 - FFMQpre_14_1,
#     FFMQpre_17R = 6 - FFMQpre_17_1,
#     FFMQpre_19R = 6 - FFMQpre_19_1,
#     FFMQpre_22R = 6 - FFMQpre_22_1,
#     FFMQpre_23R = 6 - FFMQpre_23_1,
#     FFMQpre_24R = 6 - FFMQpre_24_1,
#     #create scales
#     Desc_Ex_pre =
#         FFMQpre_1_1 + FFMQpre_2_1 + FFMQpre_5R + FFMQpre_11R + FFMQpre_16_1,
#     Non_react_pre = 
#         FFMQpre_3_1 + FFMQpre_9_1 + FFMQpre_13_1 + FFMQpre_18_1 + FFMQpre_21_1,
#     Observe_inner_pre = 
#         FFMQpre_6_1 + FFMQpre_10_1 + FFMQpre_15_1 + FFMQpre_20_1,
#     Self_compasion_pre = 
#         FFMQpre_4R + FFMQpre_7R + FFMQpre_14R + FFMQpre_19R + FFMQpre_24R,
#     Acting_mindful_pre = 
#         FFMQpre_8R + FFMQpre_12R + FFMQpre_17R + FFMQpre_22R + FFMQpre_23R,
#     FFMQ_pre_total = 
#         Desc_Ex_pre + Non_react_pre + Observe_inner_pre+ Self_compasion_pre + Acting_mindful_pre
#     )
# Mothership <- left_join(Mothership,FMMQ_pre, by = join_by(ID1 == ID1))
# 
# FMMQ_post <- read_sav("~/Desktop/Coding/data/ACT_scores/FFMQPost_1.sav")
# FMMQ_post <- FMMQ_post|>
#   mutate(
#     #reverse code items
#     FFMQpost_4R  = 6 - FFMQpost_4_1,
#     FFMQpost_5R  = 6 - FFMQpost_5_1,  
#     FFMQpost_7R  = 6 - FFMQpost_7_1, 
#     FFMQpost_8R  = 6 - FFMQpost_8_1, 
#     FFMQpost_11R = 6 - FFMQpost_11_1, 
#     FFMQpost_12R = 6 - FFMQpost_12_1,
#     FFMQpost_14R = 6 - FFMQpost_14_1,
#     FFMQpost_17R = 6 - FFMQpost_17_1,
#     FFMQpost_19R = 6 - FFMQpost_19_1,
#     FFMQpost_22R = 6 - FFMQpost_22_1,
#     FFMQpost_23R = 6 - FFMQpost_23_1,
#     FFMQpost_24R = 6 - FFMQpost_24_1,
#     #create scales
#     Desc_Ex_post =
#         FFMQpost_1_1 + FFMQpost_2_1 + FFMQpost_5R + FFMQpost_11R + FFMQpost_16_1,
#     Non_react_post = 
#         FFMQpost_3_1 + FFMQpost_9_1 + FFMQpost_13_1 + FFMQpost_18_1 + FFMQpost_21_1,
#     Observe_inner_post = 
#         FFMQpost_6_1 + FFMQpost_10_1 + FFMQpost_15_1 + FFMQpost_20_1,
#     Self_compasion_post = 
#         FFMQpost_4R + FFMQpost_7R + FFMQpost_14R + FFMQpost_19R + FFMQpost_24R,
#     Acting_mindful_post = 
#         FFMQpost_8R + FFMQpost_12R + FFMQpost_17R + FFMQpost_22R + FFMQpost_23R,
#     FFMQ_post_total = 
#         Desc_Ex_post + Non_react_post + Observe_inner_post + Self_compasion_post + Acting_mindful_post
#     )
# Mothership <- left_join(Mothership,FMMQ_post, by = join_by(ID1 == ID1))

# df_5 <- read_sav("~/Desktop/Coding/data/ACT_scores/FFMQPost_4250-4350.sav")
```
...
####  Export as CSV
write.csv(Mothership,paste0(data_path,"Mothership_paper"))
...
### Export as CSV
write.csv(Mothership,paste0(data_path,"Mothership_Diag_treat.csv"))
...
```{r}
Mothership_Missing <- Mothership_post |>
  select(
    ID1, 
    # RDQ
    # rdqPRE_coping:rdqPRE_wbs,
    rdqPOST_coping:rdqPOST_wbs,
    #For table 3 - RCI info
    CUXOS_pre, CUXOS_post,CUDOS_pre, CUDOS_post, 
    #ACT stuff
    # AAQIIpre,AAQIIpost,
    # Desc_Ex_pre, Non_react_pre, Observe_inner_pre, Self_compasion_pre, 
    # Acting_mindful_pre, 
    # Desc_Ex_post, Non_react_post, Observe_inner_post, Self_compasion_post, 
    # Acting_mindful_post 
  )

install.packages('naniar')
library(naniar)
vis_miss(Mothership_Missing)
```
...
write_csv(table1_tab_anx,paste0("C:/Users/troyh/OneDrive - University of Kentucky/Coding/data/table1_tab_anx_test.csv"))
...
table1_tab_dep
write_csv(table1_tab_dep,paste0(data_path,"table1_tab_dep_test.csv"))
...
anx_fig <- Mothership_lasso_anx |>
  mutate(
      Anxiety_Responder = as.factor(recode(Anxiety_Responder,
        "Non-Responder" = paste0("Non-Responder (n=",summary(Mothership_lasso_anx$Anxiety_Responder)[[2]],")"),
        "Responder" = paste0("Responder (n=",summary(Mothership_lasso_anx$Anxiety_Responder)[[1]],")")
      )))

dep_fig <- Mothership_lasso_dep |>
  mutate(
      Depression_Responder = as.factor(recode(Depression_Responder,
        "Non-Responder" = paste0("Non-Responder (n=",summary(Mothership_lasso_dep$Depression_Responder)[[2]],")"),
        "Responder" = paste0("Responder (n=",summary(Mothership_lasso_dep$Depression_Responder)[[1]],")")
      )))

subset(dep_fig, !is.na(Depression_Responder)) |>
  ggplot(aes(x=CUDOS_pre, y=CUDOS_post, color=Depression_Responder)) +
  geom_point(position = position_jitter(.3),size=2,alpha=.75)+
  # geom_jitter(size=2,alpha=.75)+
  theme_classic()+
  scale_color_manual(values=c("darkgrey","#23c4cc"))+
  geom_abline(intercept = 0, slope = 1,linetype='dotted',size=.75)+
  geom_abline(intercept = 13, slope = 1, col = 'black',size=1)+
  geom_abline(intercept = -13, slope = 1, col = 'black',size=1)+
  geom_hline(yintercept =21, linetype = 'dashed',size = 1) +
    labs(
    title="         RCI Analysis of Depression Treatment Response\n",
    color = "  Depression Response",
    x = "Pre CUDOS",
    y= " Post CUDOS"
  )
  

subset(anx_fig, !is.na(Anxiety_Responder)) |>
  ggplot(aes(x=CUXOS_pre, y=CUXOS_post, color=Anxiety_Responder)) +
  geom_point(position = position_jitter(.3),size=2,alpha=.75)+
  # geom_jitter(size=2,alpha=.75)+
  theme_classic()+
  scale_color_manual(values=c("darkgrey","#e6402e"))+
  geom_abline(intercept = 0, slope = 1,linetype='dotted',size=.75)+
  geom_abline(intercept = 21, slope = 1, col = 'black',size=1)+
  geom_abline(intercept = -21, slope = 1, col = 'black',size=1)+
  geom_hline(yintercept =16.6, linetype = 'dashed',size = 1)+
  labs(
    title="           RCI Analysis of Anxiety Treatment Response\n",
    color = " Anxiety Response",
    x = "Pre CUXOS",
    y= " Post CUXOS"
  )
...
#   annotate("text", x = .5, y = length(FP_dep$Variable) + 1, label = "Less Likely", size= 4) +
#   annotate("text", x = 1.5, y = length(FP_dep$Variable) + 1, label = "More Likely",size= 4) +
...
probabilities <- model.min %>% predict(newx = x.test,"response")
...
x.test <- model.matrix(Depression_Responder ~., test.data)[,-1]
probabilities <- lasso.model.min.dep %>% predict(newx = x.test,type ="response")
predicted.classes <- ifelse(probabilities > 0.5, "Responder", "Non-Responder")
# Model accuracy
observed.classes <- test.data$Depression_Responder
...
# Make prediction on test data
x.test <- model.matrix(Depression_Responder ~., test.data)[,-1]
probabilities.1se <- lasso.model.1se.dep %>% predict(newx = x.test,type ="response")
predicted.classes.1se <- ifelse(probabilities.1se > 0.5, "Responder", "Non-Responder")

# Model accuracy rate
observed.classes <- test.data$Depression_Responder
Mean.predict.1se.dep <- mean(predicted.classes.1se == observed.classes)
...
# Make predictions
probabilities.full <- full.model.dep %>% predict(test.data, type = "response")
predicted.classes.full <- ifelse(probabilities.full > 0.5, "Responder", "Non-Responder")
# Model accuracy
observed.classes.full <- test.data$Depression_Responder
Mean.predict.full.model.dep <- mean(predicted.classes.full == observed.classes)
...
Vars_dep <- Vars_dep |>
  mutate(
    YA_Treatment = as.factor(ifelse(IPT_track_1 == "Young Adult",1,0)),
    Trauma_Treatment = as.factor(ifelse(IPT_track_1 == "Trauma",1,0))
  )

# min model - post AAQII no Mindful stuff
glm_min_dep <-
          glm(
    #Outcome varaible
      Depression_Responder ~
    # predictors
      Age_1  + Some_College + Female +
      Married + White + Trauma_Treatment + 
      YA_Treatment + Days_complete_1 + Days_not_attended_1 + 
      BPD_P+ Trauma_D+ Other+ 
      Mood_C+ Trauma_C + Substance_C + 
      Current_Dx + CUXOS_pre + CUXOS_pre +
...
#       Depression_Responder ~
#     # predictors
#        Age_1 + Days_not_attended_1 + CUXOS_pre + rdqPOST_coping + rdqPOST_pmh 
#        + rdqPOST_func + rdqPOST_wbs
#     #data
#       data = Vars_dep,
#     # type of regression : logistic = binary / binomial
#       family = "binomial",
...
# R^2 values  
  ...
  #wald
   library(aod)
   dep_wald  <- wald.test(b = coef(glm_min_dep),Sigma = vcov(glm_min_dep),Terms= 2:22)
  wald <- wald.test(b = coef(glm_min_dep),Sigma = vcov(glm_min_dep),Terms=2)$result$chi2[1]
  for(i in 3:22){
      wald <- append(wald, wald.test(b = coef(glm_min_dep),Sigma = vcov(glm_min_dep),Terms=i)$result$chi2[1])
  }
  wald
...
FP.min.dep$Beta =   round(tidy.summary.min.dep$estimate[2:22],3)
FP.min.dep$Wald = round(wald,2)
  
FP.min.dep

write_csv(FP.min.dep, paste0(data_path,"FP.min.dep"))
```
1se -
```{r}
...
write_csv(FP.1se.dep, paste0(data_path,"FP.1se.dep"))
```
...
FP.min.dep <- data.frame(cbind(
  Variable = tidy.summary.min.dep$term[2:length(tidy.summary.min.dep$term)],
  Beta =round(tidy.summary.min.dep$estimate[2:11],3),
  Wald = round(wald,2),
  OR = round(as.numeric(OR.min.dep[2:length(OR.min.dep)]),2),
  OR_low  = round(as.numeric(CI.min.dep[2:length(CI.min.dep$X2.5..),1]),2),
  OR_high = round(as.numeric(CI.min.dep[2:length(CI.min.dep$X97.5..),2]),2),
  p.values = p.values.min.dep$X2[2:length(p.values.min.dep$X2)]
  ))
FP.min.dep <- left_join(FP.min.dep,ADJ.p.values.min.dep, by = join_by(p.values == p.value))
FP.min.dep
...
#create FP df
dep_df <- data.frame(rbind(
  #Block 1
  NA,NA,
  arrange(FP.min.dep,desc(OR)),
  #Top row
  NA
))

dep_df <- mutate(dep_df,
    OR = as.numeric(OR),
    OR_low = as.numeric(OR_low),
    OR_high = as.numeric(OR_high),
...
dep_df$Variable <- c(
    paste0("X^2 = ", round(dep_wald$result$chi2[1],2),", p<0.001"),
    paste0("Model R^2 = ", round((R2.min.dep[[1]]*100),3),"%"),
"Other Disorder", "Trauma Treatment", "Male","Unmarried", "Young Adult Treatment",       
"Days Not Attended", "White", "# of Diagnosis", "Age", "Days completed", "Pre CUXOS",          
"Post Wellbeing", "Post Positive Mental Helath", "Post Functioning", "Post Coping Ability", "Some College","BPD", "Trauma Disorder", "Co-occuring Mood Disorder", "Co-occuring Trauma Disorder", "Co-occuring SUD",  "Variable"
    )
...
dep_df[24,2] = "Beta"
dep_df[24,3] = "Wald"
dep_df[24,12] = "OR [95% CI]"
dep_df[24,10] = "Adjusted p"
dep_df$order = c(seq(2,length(dep_df$order),1),1)
#Final df for FP
dep_df

write_csv(dep_df, paste0(data_path,"dep_df"))
```
...
# Make prediction on test data
x.test <- model.matrix(Anxiety_Responder ~., test.data)[,-1]
probabilities <- lasso.model.min.anx %>% predict(newx = x.test,type="response")
predicted.classes <- ifelse(probabilities > 0.5, "Responder", "Non-Responder")
# Model accuracy
observed.classes <- test.data$Anxiety_Responder
...
# Make prediction on test data
x.test <- model.matrix(Anxiety_Responder ~., test.data)[,-1]
probabilities <- lasso.model.1se.anx %>% predict(newx = x.test,type="response")
predicted.classes <- ifelse(probabilities > 0.5, "Responder", "Non-Responder")
...
Vars_anx <- Vars_anx |>
  ...
  glm_min_anx <-  
      ...
      #Outcome varaible
        Anxiety_Responder ~ 
      # predictors
        Age_1 + Some_College + Days_not_attended_1 + Anxiety_D + BPD_Co_C + 
        Substance_C + rdqPOST_coping + rdqPOST_pmh + rdqPOST_func + rdqPOST_wbs,
      #data
      data = Vars_anx, 
      # type of regression : logistic = binary / binomial
      family = "binomial")
...
#wald
   library(aod)
   anx_wald  <- wald.test(b = coef(glm_min_anx),Sigma = vcov(glm_min_anx),Terms= 2:10)
  wald <- wald.test(b = coef(glm_min_anx),Sigma = vcov(glm_min_anx),Terms=2)$result$chi2[1]
  for(i in 3:11){
      wald <- append(wald, wald.test(b = coef(glm_min_anx),Sigma = vcov(glm_min_anx),Terms=i)$result$chi2[1])
  }
  wald
```
...
FP.min.anx <- data.frame(cbind(
  ...
  Beta =round(tidy.summary.min.anx$estimate[2:11],3),
  Wald = round(wald,2),
  OR = round(as.numeric(OR.min.anx[2:length(OR.min.anx)]),2),
  OR_low  = round(as.numeric(CI.min.anx[2:length(CI.min.anx$X2.5..),1]),2),
  OR_high = round(as.numeric(CI.min.anx[2:length(CI.min.anx$X97.5..),2]),2),
...
write_csv(FP.min.anx, paste0(data_path,"FP.min.anx"))

#create FP df
anx_df <- data.frame(rbind(
  #Block 1
  NA,NA,
  arrange(FP.min.anx,desc(OR)),
  #Top row
  NA
))

anx_df <- mutate(anx_df,
    OR = as.numeric(OR),
    OR_low = as.numeric(OR_low),
    OR_high = as.numeric(OR_high),
    sig = ifelse(is.na(p.adjusted), NA, 
...
#assign variable names
anx_df$Variable <- c(
    paste0("X^2 = ", round(anx_wald$result$chi2[1],2),", p<0.001"),
    paste0("Model R^2 = ", round((R2.min.anx[[1]]*100),3),"%"),
    "Co-occuring BPD", "Days Not Attended", "Age", "Post Functioning", 
    "Post Sense of Wellbeing", "Post PMH", "Post Coping", "Some College",
    "Co-occuring SUD", "Anxiety Disorder",
    "Variable"
    )
...
anx_df[13,2] = "Beta"
anx_df[13,3] = "Wald"
anx_df[13,12] = "OR [95% CI]"
anx_df[13,10] = "Adjusted p"
anx_df$order = c(seq(2,length(anx_df$order),1),1)
#Final df for FP
anx_df

# write_csv(anx_df, "~/Downloads/anx_df")
...
ANX_FP <- 
  ...
  geom_linerange(aes(xmin=OR_low, xmax=OR_high),size = 1, show.legend = FALSE,
                color = ifelse(anx_df$p.adjusted < 0.05, "#e6402e", "darkgrey")) +
  geom_errorbar(aes(xmin=OR_low, xmax=OR_high),width =.3, show.legend = FALSE,
                color = ifelse(anx_df$p.adjusted < 0.05, "#e6402e", "darkgrey"))+
...
# geom_errorbar(aes(xmin=OR_low, xmax=OR_high),width =.6, show.legend = FALSE) +
  ...
  labs(
    ...
    subtitle ="Odds of Anxiety Non-Response")+
  #adjust the dimentions. 
  coord_cartesian(ylim = c(1,  length(anx_df$Variable)))+
  #add a line at 1 for reference 
  geom_vline(xintercept = 1,linetype="dashed",alpha = .50) + 
  #add anotations to help suggests what each side means.
  annotate("text", x = .6, y = length(anx_df$Variable) -1 , label = "Less Likely", size= 4) +
  annotate("text", x = 1.4, y = length(anx_df$Variable) -1, label = "More Likely",size= 4) +
  #Git rid of the Y - Axis
    theme(axis.line.y = element_blank(),
        axis.ticks.y= element_blank(),
        axis.text.y= element_blank(),
...
ANX_text <- 
  ...
  geom_text(aes(x = 0, label = Variable), hjust = 0,
        fontface = ifelse(anx_df$Variable == "Variable","bold","plain")) +
  geom_text(aes(x = 1.1, label = Beta),
        hjust = 0,
        fontface = ifelse(anx_df$Beta == "Beta", "bold","plain")) + 
  geom_text(aes(x = 1.5, label = Wald),
        hjust = 0,
        fontface = ifelse(anx_df$Wald == "Wald", "bold","plain")) +
  geom_text(aes(x = 1.9, label = label),
        hjust = 0,
        fontface = ifelse(anx_df$label == "OR [95% CI]", "bold","plain")) +
  theme_void() +     
  coord_cartesian(ylim = c(1,length(anx_df$Variable)), xlim = c(0, 4))
...
ANX_text + ANX_FP + plot_layout(design = layout)
```
...
DEP_FP <- 
  ...
  #make the forrest plot
    geom_linerange(aes(xmin=OR_low, xmax=OR_high),size = 1, show.legend = FALSE,
                color = ifelse(dep_df$p.adjusted < 0.05, "#23c4cc", "darkgrey")) +
    geom_errorbar(aes(xmin=OR_low, xmax=OR_high),width =.4, show.legend = FALSE,
                color = ifelse(dep_df$p.adjusted < 0.05, "#23c4cc", "darkgrey")) +
  # geom_errorbar(aes(xmin=OR_low, xmax=OR_high),width =.35, show.legend = FALSE,
                # color = ifelse(dep_df$p.adjusted < 0.05, "#23c4cc", "darkgrey"))+
      geom_point(aes(x=OR), shape= 16,
  ...
  labs(
    x="Odds Ratio",
    # title = "    Odds of Meeting Physical Activity Guidelines",
    subtitle ="Odds of Depression Non-Response") +
  #adjust the dimentions. 
  coord_cartesian(ylim = c(1,  length(dep_df$Variable)),
                  xlim = c(0.4,2)) +
  #add a line at 1 for reference 
  geom_vline(xintercept = 1,linetype="dashed",alpha = .50) +
  #add anotations to help suggests what each side means.
  annotate("text", x = .6, y = length(dep_df$Variable) -1 , label = "Less Likely", size= 4) +
  annotate("text", x = 1.4, y = length(dep_df$Variable) -1, label = "More Likely",size= 4) +
  #Git rid of the Y - Axis
    theme(axis.line.y = element_blank(),
        axis.ticks.y= element_blank(),
        axis.text.y= element_blank(),
...
DEP_text <- 
  ...
  ggplot(aes(y = reorder(Variable, -order))) +
  geom_text(aes(x = 0, label = Variable), hjust = 0,
        fontface = ifelse(dep_df$Variable == "Variable","bold","plain")) +
  geom_text(aes(x = 1.1, label = Beta),
        hjust = 0,
        fontface = ifelse(dep_df$Beta == "Beta", "bold","plain")) + 
  geom_text(aes(x = 1.5, label = Wald),
        hjust = 0,
        fontface = ifelse(dep_df$Wald == "Wald", "bold","plain")) +
  geom_text(aes(x = 1.9, label = label),
        hjust = 0,
        fontface = ifelse(dep_df$label == "OR [95% CI]", "bold","plain")) +
  theme_void() +     
  coord_cartesian(ylim = c(1,length(dep_df$Variable)), xlim = c(0, 4))
...
DEP_text + DEP_FP + plot_layout(design = layout)
```
...
# 
# layout <- c(
#   patchwork::area(t = 0, l = 0, b = 30, r = 35),
#   patchwork::area(t = 0, l = 19, b = 30, r = 34),
#   patchwork::area(t = 0, l = 30, b = 30, r = 40) 
#   )
# 
