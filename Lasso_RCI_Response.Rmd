...
table1_tab_dep[9,5] <- round(fisher.test(cbind(OR_IPT_Tab[,"General"],OR_IPT_Tab[,"Trauma"]))$estimate,2)
# OR General vs Young adult track 
table1_tab_dep[10,5] <- 
  round(fisher.test(cbind(OR_IPT_Tab[,"General"],OR_IPT_Tab[,"Young Adult"]))$estimate,2)
...
round(table1_tab_dep[11,5] <- cohens_d(Days_complete_1 ~ Depression_Responder, data = Mothership_lasso)$effsize,2)
...
round(table1_tab_dep[12,5] <- cohens_d(Days_not_attended_1 ~ Depression_Responder, data = Mothership_lasso)$effsize,2)
# Anxiety disorder
