...
#       Depression_Responder ~
#     # predictors
#       White  +   Anxiety_C + BPD_Co_C+  Current_Dx + CUXOS_pre + 
#       Self_compasion_pre,
#     #data
#       data = Vars_dep,
#     # type of regression : logistic = binary / binomial
...
# R^2 values  
  ...
  #wald
   library(aod)
   wald.test(b = coef(glm_min_dep),Sigma = vcov(glm_min_dep),Terms= 2:7)
...
## min model
  glm_min_anx <-  
      ...
      #Outcome varaible
        Anxiety_Responder ~ 
      # predictors
        Female + Married + White + Days_not_attended_1 + 
        Anxiety_D +  BPD_Co_C + CUXOS_pre +  
        AAQIIpost + Non_react_post + Self_compasion_post + Acting_mindful_post,
      #data
      data = Vars_anx, 
      # type of regression : logistic = binary / binomial
      family = "binomial")
