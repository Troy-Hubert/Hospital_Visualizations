...
colnames(JT_DF) <- paste0(colnames(JT_DF),"_anx")

JT_DF2<- DEP_JT
colnames(JT_DF2) <- paste0(colnames(JT_DF2),"_dep")
...
JT Numbers
```{r}
Mothership_post <- left_join(Mothership_post,JT_DF, by = join_by(ID1 == ID1)) |>
  mutate(
...
Mothership_lasso <- Mothership_post |>
  ...
  select( c(
    Anxiety_Responder, Depression_Responder,Disorder_treat,
    # Demographics
...
Mothership_lasso <- na.omit(Mothership_lasso)
...
table1_vars_anx <- c("Anxiety_Responder",colnames(Mothership_lasso)[-1:-3])
table1_vars_anx <- table1_vars_anx[1:28]


colnames(Mothership_lasso)[-1]
## Vector of categorical variables that need transformation
catVars <- c("Some_College", "Female" , "Married", "White",
             "IPT_track_1","Anxiety_D", "Mood_D", "BPD_P" ,"Trauma_D","Substance_D" ,        
             "Psychotic_D", "Other", "Anxiety_C", "Mood_C" , "BPD_Co_C", "Trauma_C", 
...
table1_tab_anx <- CreateTableOne(vars = table1_vars_anx, data = Mothership_lasso,strata ="Anxiety_Responder",  factorVars = catVars)
table1_tab_anx <- print(table1_tab_anx, formatOptions = list(big.mark = ","))
table1_tab_anx <- data.frame(table1_tab_anx)
table1_tab_anx<- table1_tab_anx[-2,]
...
# age
table1_tab_anx[2,4] <- round(t_test(Age_1 ~ Anxiety_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_anx[2,5] <- round(cohens_d(Age_1 ~ Anxiety_Responder, data = Mothership_lasso)$effsize,2)
# Some College 
table1_tab_anx[3,4] <- round(chisq.test(Mothership_lasso$Some_College, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[3,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$Some_College))$estimate,2)
# Female
table1_tab_anx[4,4] <- round(chisq.test(Mothership_lasso$Female, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[4,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$Female))$estimate,2)
# Married
table1_tab_anx[5,4] <- round(chisq.test(Mothership_lasso$Married, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[5,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$Married))$estimate,2)
# White
table1_tab_anx[6,4] <- round(chisq.test(Mothership_lasso$White, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[6,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$White))$estimate,2)
# Treatment track
table1_tab_anx[7,4] <- round(chisq.test(Mothership_lasso$IPT_track_1, Mothership_lasso$Anxiety_Responder)$statistic,2)
OR_IPT_anx <- table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$IPT_track_1)
# OR general vs Trauma track
table1_tab_anx[9,5] <- round(fisher.test(cbind(OR_IPT_anx[,"General"],OR_IPT_anx[,"Trauma"]))$estimate,2)
table1_tab_anx[9,3] <-
...
table1_tab_anx[11,4] <- round(t_test(Days_complete_1 ~ Anxiety_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_anx[11,5] <- round(cohens_d(Days_complete_1 ~ Anxiety_Responder, data = Mothership_lasso)$effsize,2)
# Days not attending treatment
table1_tab_anx[12,4] <- round(t_test(Days_not_attended_1 ~ Anxiety_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_anx[12,5] <- round(cohens_d(Days_not_attended_1 ~ Anxiety_Responder, data = Mothership_lasso)$effsize,2)
# Anxiety disorder
table1_tab_anx[13,4] <- round(chisq.test(Mothership_lasso$Anxiety_D, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[13,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$Anxiety_D))$estimate,2)
# Mood Disorders
table1_tab_anx[14,4] <- round(chisq.test(Mothership_lasso$Mood_D, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[14,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$Mood_D))$estimate,2)
# BPD 
table1_tab_anx[15,4] <- round(chisq.test(Mothership_lasso$BPD_P, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[15,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$BPD_P))$estimate,2)
# Truama Related Disorders
table1_tab_anx[16,4] <- round(chisq.test(Mothership_lasso$Trauma_D, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[16,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$Trauma_D))$estimate,2)
# Other Disorders
table1_tab_anx[17,4] <- round(chisq.test(Mothership_lasso$Other, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[17,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$Other))$estimate,2)
# Co-occurring anxiety disorder 
table1_tab_anx[18,4] <- round(chisq.test(Mothership_lasso$Anxiety_C, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[18,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$Anxiety_C))$estimate,2)
# Co-occurring mood disorder
table1_tab_anx[19,4] <- round(chisq.test(Mothership_lasso$Mood_C, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[19,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$Mood_C))$estimate,2)
# Co-occurring BPD
table1_tab_anx[20,4] <- round(chisq.test(Mothership_lasso$BPD_Co_C, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[20,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$BPD_Co_C))$estimate,2)
# Co-occurring Trauma Related Disorder
table1_tab_anx[21,4] <- round(chisq.test(Mothership_lasso$Trauma_C, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[21,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$Trauma_C))$estimate,2)
# Co-occurring Substance Use Disorders
table1_tab_anx[22,4] <- round(chisq.test(Mothership_lasso$Substance_C, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[22,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$Substance_C))$estimate,2)
# Co-occurring Other Disroders
table1_tab_anx[23,4] <- round(chisq.test(Mothership_lasso$Other_C, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[23,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$Other_C))$estimate,2)
# No Co-occurring Disorders
table1_tab_anx[24,4] <- round(chisq.test(Mothership_lasso$No_Co, Mothership_lasso$Anxiety_Responder)$statistic,2)
table1_tab_anx[24,5] <- round(fisher.test(table(Mothership_lasso$Anxiety_Responder,Mothership_lasso$No_Co))$estimate,2)
# Number of Current diagnoses 
table1_tab_anx[25,4] <- round(t_test(Current_Dx ~ Anxiety_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_anx[25,5] <- round(cohens_d(Current_Dx ~ Anxiety_Responder, data = Mothership_lasso)$effsize,2)
# CUDOS Pre scores
table1_tab_anx[26,4] <- round(t_test(CUDOS_pre ~ Anxiety_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_anx[26,5] <- round(cohens_d(CUDOS_pre ~ Anxiety_Responder, data = Mothership_lasso)$effsize,2)
# CUXOS Pre scores
table1_tab_anx[27,4] <- round(t_test(CUXOS_pre ~ Anxiety_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_anx[27,5] <- round(cohens_d(CUXOS_pre ~ Anxiety_Responder, data = Mothership_lasso)$effsize,2)
# RDQ Coping post scores
table1_tab_anx[28,4] <- round(t_test(rdqPOST_coping ~ Anxiety_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_anx[28,5] <- round(cohens_d(rdqPOST_coping ~ Anxiety_Responder, data = Mothership_lasso)$effsize,2)
# RDQ Positive Mental Health post scores
table1_tab_anx[29,4] <- round(t_test(rdqPOST_pmh ~ Anxiety_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_anx[29,5] <- round(cohens_d(rdqPOST_pmh ~ Anxiety_Responder, data = Mothership_lasso)$effsize,2)
# RDQ Functioning post scores
table1_tab_anx[30,4] <- round(t_test(rdqPOST_func ~ Anxiety_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_anx[30,5] <- round(cohens_d(rdqPOST_func ~ Anxiety_Responder, data = Mothership_lasso)$effsize,2)
# RDQ Sense of Wellbeing post scores
table1_tab_anx[31,4] <- round(t_test(rdqPOST_wbs ~ Anxiety_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_anx[31,5] <- round(cohens_d(rdqPOST_wbs ~ Anxiety_Responder, data = Mothership_lasso)$effsize,2)
...
```{r}
### next gather info based upon depression

## Vector of variables to summarize
table1_vars_dep <- c("Depression_Responder",colnames(Mothership_lasso)[-1:-3])
table1_vars_dep <- table1_vars_dep[1:28]

## Create a TableOne object
table1_tab_dep <- CreateTableOne(vars = table1_vars_dep, data = Mothership_lasso,strata ="Depression_Responder",  factorVars = catVars)
table1_tab_dep <- print(table1_tab_dep, formatOptions = list(big.mark = ","))
table1_tab_dep <-data.frame(table1_tab_dep)
table1_tab_dep <- table1_tab_dep[-2,]

# add discriptive statistics 
table1_tab_dep$ef_size = c("")

# age
table1_tab_dep[2,4] <- round(t_test(Age_1 ~ Depression_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_dep[2,5] <- round(cohens_d(Age_1 ~ Depression_Responder, data = Mothership_lasso)$effsize,2)
# Some College 
table1_tab_dep[3,4] <- round(chisq.test(Mothership_lasso$Some_College, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[3,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$Some_College))$estimate,2)
# Female
table1_tab_dep[4,4] <- round(chisq.test(Mothership_lasso$Female, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[4,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$Female))$estimate,2)
# Married
table1_tab_dep[5,4] <- round(chisq.test(Mothership_lasso$Married, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[5,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$Married))$estimate,2)
# White
table1_tab_dep[6,4] <- round(chisq.test(Mothership_lasso$White, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[6,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$White))$estimate,2)
# Treatment track
table1_tab_dep[7,4] <- round(chisq.test(Mothership_lasso$IPT_track_1, Mothership_lasso$Depression_Responder)$statistic,2)
OR_IPT_dep <- table(Mothership_lasso$Depression_Responder,Mothership_lasso$IPT_track_1)
# OR general vs Trauma track
...
# Days Completed in program
table1_tab_dep[11,4] <- round(t_test(Days_complete_1 ~ Depression_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_dep[11,5] <- round(cohens_d(Days_complete_1 ~ Depression_Responder, data = Mothership_lasso)$effsize,2)
# Days not attending treatment
table1_tab_dep[12,4] <- round(t_test(Days_not_attended_1 ~ Depression_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_dep[12,5] <- round(cohens_d(Days_not_attended_1 ~ Depression_Responder, data = Mothership_lasso)$effsize,2)
# Anxiety disorder
table1_tab_dep[13,4] <- round(chisq.test(Mothership_lasso$Anxiety_D, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[13,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$Anxiety_D))$estimate,2)
# Mood Disorders
table1_tab_dep[14,4] <- round(chisq.test(Mothership_lasso$Mood_D, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[14,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$Mood_D))$estimate,2)
# BPD 
table1_tab_dep[15,4] <- round(chisq.test(Mothership_lasso$BPD_P, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[15,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$BPD_P))$estimate,2)
# Truama Related Disorders
table1_tab_dep[16,4] <- round(chisq.test(Mothership_lasso$Trauma_D, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[16,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$Trauma_D))$estimate,2)
# Other Disorders
table1_tab_dep[17,4] <- round(chisq.test(Mothership_lasso$Other, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[17,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$Other))$estimate,2)
# Co-occurring anxiety disorder 
table1_tab_dep[18,4] <- round(chisq.test(Mothership_lasso$Anxiety_C, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[18,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$Anxiety_C))$estimate,2)
# Co-occurring mood disorder
table1_tab_dep[19,4] <- round(chisq.test(Mothership_lasso$Mood_C, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[19,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$Mood_C))$estimate,2)
# Co-occurring BPD
table1_tab_dep[20,4] <- round(chisq.test(Mothership_lasso$BPD_Co_C, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[20,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$BPD_Co_C))$estimate,2)
# Co-occurring Trauma Related Disorder
table1_tab_dep[21,4] <- round(chisq.test(Mothership_lasso$Trauma_C, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[21,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$Trauma_C))$estimate,2)
# Co-occurring Substance Use Disorders
table1_tab_dep[22,4] <- round(chisq.test(Mothership_lasso$Substance_C, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[22,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$Substance_C))$estimate,2)
# Co-occurring Other Disroders
table1_tab_dep[23,4] <- round(chisq.test(Mothership_lasso$Other_C, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[23,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$Other_C))$estimate,2)
# No Co-occurring Disorders
table1_tab_dep[24,4] <- round(chisq.test(Mothership_lasso$No_Co, Mothership_lasso$Depression_Responder)$statistic,2)
table1_tab_dep[24,5] <- round(fisher.test(table(Mothership_lasso$Depression_Responder,Mothership_lasso$No_Co))$estimate,2)
# Number of Current diagnoses 
table1_tab_dep[25,4] <- round(t_test(Current_Dx ~ Depression_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_dep[25,5] <- round(cohens_d(Current_Dx ~ Depression_Responder, data = Mothership_lasso)$effsize,2)
# CUDOS Pre scores
table1_tab_dep[26,4] <- round(t_test(CUDOS_pre ~ Depression_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_dep[26,5] <- round(cohens_d(CUDOS_pre ~ Depression_Responder, data = Mothership_lasso)$effsize,2)
# CUXOS Pre scores
table1_tab_dep[27,4] <- round(t_test(CUXOS_pre ~ Depression_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_dep[27,5] <- round(cohens_d(CUXOS_pre ~ Depression_Responder, data = Mothership_lasso)$effsize,2)
# RDQ Coping post scores
table1_tab_dep[28,4] <- round(t_test(rdqPOST_coping ~ Depression_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_dep[28,5] <- round(cohens_d(rdqPOST_coping ~ Depression_Responder, data = Mothership_lasso)$effsize,2)
# RDQ Positive Mental Health post scores
table1_tab_dep[29,4] <- round(t_test(rdqPOST_pmh ~ Depression_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_dep[29,5] <- round(cohens_d(rdqPOST_pmh ~ Depression_Responder, data = Mothership_lasso)$effsize,2)
# RDQ Functioning post scores
table1_tab_dep[30,4] <- round(t_test(rdqPOST_func ~ Depression_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_dep[30,5] <- round(cohens_d(rdqPOST_func ~ Depression_Responder, data = Mothership_lasso)$effsize,2)
# RDQ Sense of Wellbeing post scores
table1_tab_dep[31,4] <- round(t_test(rdqPOST_wbs ~ Depression_Responder, data = Mothership_lasso)$statistic,2)
table1_tab_dep[31,5] <- round(cohens_d(rdqPOST_wbs ~ Depression_Responder, data = Mothership_lasso)$effsize,2)
...
```{r}
## Vector of variables to summarize
table1_vars_gen <- c(colnames(Mothership_lasso)[-1:-3])
table1_vars_gen<- table1_vars_gen[1:27]

## lastly get the overal treatment breakdown
table1_gen <- CreateTableOne(vars = table1_vars_gen, data = Mothership_lasso,  factorVars = catVars)
table1_gen <- print(table1_gen, formatOptions = list(big.mark = ","))
table1_gen <-data.frame(table1_gen)
write_csv(table1_gen,"~/Downloads/table1_gen.csv")
table1_gen 
...
#1. Pre post score differences of anxeity and depression by treatment response:
  #1.1 depression responders   
    t.test(subset(Mothership_lasso,Depression_Responder == "Responder")$CUDOS_pre,
       subset(Mothership_lasso,Depression_Responder == "Responder")$CUDOS_post,
       paired = TRUE, alternative = "two.sided"
       )
  #1.2 depression non-responders   
     t.test(subset(Mothership_lasso,Depression_Responder == "Non-Responder")$CUDOS_pre,
       subset(Mothership_lasso,Depression_Responder == "Non-Responder")$CUDOS_post,
       paired = TRUE, alternative = "two.sided"
       )
  #1.3 anxiety responders   
    t.test(subset(Mothership_lasso,Anxiety_Responder == "Responder")$CUXOS_pre,
       subset(Mothership_lasso,Anxiety_Responder == "Responder")$CUXOS_post,
       paired = TRUE, alternative = "two.sided"
       )
  #1.2 anxiety non-responders   
     t.test(subset(Mothership_lasso,Anxiety_Responder == "Non-Responder")$CUXOS_pre,
       subset(Mothership_lasso,Anxiety_Responder == "Non-Responder")$CUXOS_post,
       paired = TRUE, alternative = "two.sided"
       )
...
#2. Differences between group differences for pre and post scores of anxiety and depression.
  #2.1 Pre scores of anxiety
     t.test(CUXOS_pre ~ Anxiety_Responder, data = Mothership_lasso)
  #2.2 Post scores of anxiety
     t.test(CUXOS_post ~ Anxiety_Responder, data = Mothership_lasso)
     sd(subset(Mothership_lasso,Anxiety_Responder == "Responder")$CUXOS_post)
     sd(subset(Mothership_lasso,Anxiety_Responder == "Non-Responder")$CUXOS_post)
     round(cohens_d(CUXOS_post ~ Depression_Responder, data = Mothership_lasso)$effsize,2)
  #2.3 Pre scores of depression
     t.test(CUDOS_pre ~ Depression_Responder, data = Mothership_lasso)
  #2.4 Post scores of depression
     t.test(CUDOS_post ~ Depression_Responder, data = Mothership_lasso)
     sd(subset(Mothership_lasso,Depression_Responder == "Responder")$CUDOS_post)
     sd(subset(Mothership_lasso,Depression_Responder == "Non-Responder")$CUDOS_post)
     round(cohens_d(CUDOS_post ~ Depression_Responder, data = Mothership_lasso)$effsize,2)
```
...
dim(Mothership_lasso)

co_dis_tab <- Mothership_lasso |>
  pivot_longer(
...
# #anxiety 
# 
# RCI_table[,1] = c("CUXOS", unlist(summary(Mothership_lasso$Anxiety_Responder)))
# # Depresssion
# RCI_table[,2] = c("CUDOS", unlist(summary(Mothership_lasso$Depression_Responder)))
# # #Total
...
# JT Table
JT_table <- data.frame(matrix(NA,nrow = 2,ncol = 3))
colnames(JT_table) = c("Varaibles","Responder","Non-Responder")
#anxiety 

JT_table[1,] = c("CUXOS", unlist(summary(Vars_anx$Anxiety_Responder)))
# Depresssion
JT_table[2,] = c("CUDOS", unlist(summary(Vars_dep$Depression_Responder)))
...
```{r}
Mothership_lasso_dep <- Mothership_lasso |>
    filter(
    !is.na(Some_College),
    !is.na(Female),
    !is.na(IPT_track_1),
...
summary(Vars_dep$Depression_Responder)
...
## min model
  glm_min_dep <-
      ...
      #Outcome varaible
        Depression_Responder ~
      # predictors
        Days_complete_1 + Days_not_attended_1 + Mood_C + CUDOS_pre +
        CUXOS_pre + 
...
# Coefficients
  coefs.1se.dep <- abs(coef(glm_1se_dep))

# Odds ratio
  OR.1se.dep <- exp(coef(glm_1se_dep))
  
# OR 95% CI
  CI.1se.dep <- data.frame(exp(confint(glm_1se_dep)))
...
```{r}
Mothership_lasso_anx <- Mothership_lasso |>
    filter(
    !is.na(Some_College),
    !is.na(Female),
    !is.na(IPT_track_1),
...
## min model
  glm_min_anx <-  
      ...
      #Outcome varaible
        Anxiety_Responder ~ 
      # predictors
        Age_1 + Married + Days_complete_1 + Days_not_attended_1 +
        Anxiety_D + BPD_Co_C + 
        rdqPOST_coping + rdqPOST_pmh + rdqPOST_func,
      #data
      data = Vars_anx, 
      # type of regression : logistic = binary / binomial
      family = "binomial")
...
FP_anx$Variable = c(
                    "Age", "Unmarried", "Days Completed", "Days Not Attended",
                    "Anxiety Disorder", "Co-Occuring BPD",
                    "Coping Ability", "Positive Mental Health", "Functioning"
                    )
# FP_anx$Variable = c(                      
#                     "Days Completed","Days Not Attended","Anxiety Disroder","CUXOS Pre-score",
#                     "Coping Ability","Positive Mental Health", "Functioning"   
#                     )
...
FP_anx_m <- FP_anx |>
  ...
  annotate("text", x = .75, y = length(FP_anx$Variable) + 1, label = "Less Likely", size= 3) +
  annotate("text", x = 1.25, y = length(FP_anx$Variable) + 1, label = "More Likely",size= 3) +
...
FP_dep <- read_csv("~/Downloads/FP.min.dep")

#rename the variables for the figure
# FP_dep$Variable = c(
#                     "Days Completed", "Days Not Attended", 
#                     "Co-Ocurring Mood Disorder", "CUXOS Pre-Score", "CUDOS Pre-Score",
#                     "Coping Ability", "Positive Mental Health", "Functioning", 
#                     "Sense of Well Being"
#                     )
FP_dep$Variable = c(
...
FP_dep_m <- FP_dep |>
  ...
  #add a line at 1 for reference 
   geom_vline(xintercept = 1, linetype="dashed", alpha = .5) +
  #add anotations to help suggests what each side means.
  annotate("text", x = .8, y = length(FP_dep$Variable) + 1, label = "Less Likely", size= 4) +
  annotate("text", x = 1.2, y = length(FP_dep$Variable) + 1, label = "More Likely",size= 4) +
  #Git rid of the Y - Axis
    theme(axis.line.y = element_blank(),
        axis.ticks.y= element_blank(),
        axis.text.y= element_blank(),
