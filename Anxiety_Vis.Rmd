...
```{r}
#Overall race
Mothership_Mean_CUXOS_Race<-Mothership_Long %>%
...
Mothership_Mean_CUXOS_Gender<-Mothership_Long %>%
...
Mothership_Mean_CUXOS_Track<-Mothership_Long %>%
...
ggplot(data=subset(Mothership_Mean_CUXOS_Track,!is.na(IPT_track_1)),
  ...
  geom_vline(xintercept = 8,alpha =.25)+
  geom_vline(xintercept = 13,alpha =.25)+
  annotate("text", x = 5, y = 45, label = "Q1") +
  annotate("text", x = 8, y = 45, label = "Mean") +
  annotate("text", x = 13, y = 45, label = "Q3") 
```
...
Track1<-ggplot(data=subset(TrackDF1,!is.na(IPT_track_1)),
  ...
  geom_point(size=.5)+
  labs(
    title ="Anxiety Severity by Track During Partial Hospitalization",
    subtitle = "Patient discharge 1-5 days")+
    scale_x_continuous(name="Treatment Day",limits=c(0,20,by=1))+
  scale_y_continuous(name="Anxiety Severity",limits=c(10,50,by=5))+
  scale_color_manual(values=c("#209845","#3D4A3E","#A0AFA1",
...
Track3<-ggplot(data=subset(TrackDF3,!is.na(IPT_track_1)),
  ...
  geom_line(size=.5)+
  geom_point(size=.5)+
  labs(title ="Anxiety Severity by Track During Partial Hospitalization",
    subtitle = "Patient discharge 11-15 days")+
    scale_x_continuous(name="Treatment Day",limits=c(0,20,by=1))+
  scale_y_continuous(name="Anxiety Severity",limits=c(10,50,by=5))+
  scale_color_manual(values=c("#209845","#3D4A3E","#A0AFA1",
...
Mothership_Mean_CUXOS_Ed<-Mothership_Long %>%
...
Education1<-ggplot(data=subset(EducationDF1,!is.na(Education_1)),
  ...
  geom_line(size=.5)+
  geom_point(size=.5)+
  labs(title ="Anxiety Severity by Education Level During Partial Hospitalization",
    subtitle = "Patient discharge 1-5 days")+
    scale_x_continuous(name="Treatment Day",limits=c(0,20,by=1))+
  scale_y_continuous(name="Anxiety Severity",limits=c(10,50,by=5))+
  scale_color_manual(values=c("#209845","#3D4A3E","#A0AFA1",
...
Mothership_Mean_CUXOS_Year<-Mothership_Long %>%
...
YEARTX1<-ggplot(data=subset(YEARTXDF1,!is.na(TxYear)),
  ...
  geom_line(size=.5)+
  geom_point(size=.5)+
  labs(title ="Anxiety Severity by YEARTX",
    subtitle = "Patient discharge 1-5 days")+
    scale_x_continuous(name="Treatment Day",limits=c(0,20,by=1))+
  scale_y_continuous(name="Anxiety Severity",limits=c(10,50,by=5))+
  scale_color_manual(values=c("#209845","#3D4A3E","#A0AFA1",
