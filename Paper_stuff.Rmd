...
Mothership_post <- Mothership |>
  ...
  mutate(
    Delta_Anx_DC = BL_CUXOS - SUManx_DC,
    Delta_Dep_DC = BL_CUDOS - SUMdep_DC,
    Percent_anx_change = SUManx_DC - BL_CUXOS/BL_CUXOS,
    Percent_Dep_Dchange = SUMdep_DC - BL_CUDOS/BL_CUDOS,
    #Days_complete_W = ifelse(Days_complete_1 > 40, 40, Days_complete_1),
    Anx_Responder = as.factor(
      ifelse(BL_CUXOS > 10 &(Delta_Anx_DC/BL_CUXOS) <= .5 & (Delta_Anx_DC/BL_CUXOS) >= 0, "Anx Responder",
      ifelse(BL_CUXOS > 10 & Delta_Anx_DC/BL_CUXOS < 0, "Anx Worse", 
      ifelse(BL_CUXOS > 10 & Delta_Anx_DC/BL_CUXOS < 1 & Delta_Anx_DC/BL_CUXOS > .5,  "Unresponders", "Low BL Anx"      
      )))),
    Dep_Responder = as.factor(
      ifelse(BL_CUDOS > 10 & (Delta_Dep_DC/BL_CUDOS) <= .5 & (Delta_Dep_DC/BL_CUDOS) >= 0, "Dep Responder",
      ifelse(BL_CUDOS > 10 & Delta_Dep_DC/BL_CUDOS < 0, "Dep Worse", 
      ifelse(BL_CUDOS > 10 & Delta_Anx_DC/BL_CUXOS <= 1 & Delta_Anx_DC/BL_CUXOS > .5,  "Unresponders", "Low BL Dep" 
      )))),
    Treatment_Responder = as.factor(
      ifelse(BL_CUXOS > 10 & (Delta_Anx_DC/BL_CUXOS) < .5 & (Delta_Anx_DC/BL_CUXOS) >= 0, "Anx Responder",
      ifelse((Delta_Dep_DC/BL_CUDOS) < .5 & (Delta_Dep_DC/BL_CUDOS) >= 0, "Dep Responder",
      ifelse(BL_CUXOS > 10 & BL_CUDOS > 10 &(Delta_Anx_DC/BL_CUXOS) < .5 & (Delta_Anx_DC/BL_CUXOS) >= 0 & (Delta_Dep_DC/BL_CUDOS) < .5 & (Delta_Dep_DC/BL_CUDOS) >= 0, "Both_Responder", 
      ifelse(BL_CUXOS > 10 & Delta_Anx_DC/BL_CUXOS < 0, "Anx Worse",
      ifelse(BL_CUDOS > 10 & Delta_Dep_DC/BL_CUDOS < 0, "Dep Worse",
      ifelse(BL_CUXOS > 10 & BL_CUDOS > 10 & Delta_Anx_DC/BL_CUXOS < 1 & Delta_Anx_DC/BL_CUXOS >= .5 & Delta_Dep_DC/BL_CUDOS < 1 & Delta_Dep_DC/BL_CUDOS >= .5, "Both Unresponder",
      ifelse(BL_CUDOS > 10 & Delta_Dep_DC/BL_CUDOS < 1 & Delta_Dep_DC/BL_CUDOS >= .5, "Dep Unresponders", 
      ifelse(BL_CUXOS > 10 & Delta_Anx_DC/BL_CUXOS < 1 & Delta_Anx_DC/BL_CUXOS >= .5, "Anx Unresponders", "Low Baseline"
      ))))))))))
