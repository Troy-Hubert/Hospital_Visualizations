...
#### Figure out how to:
    #1. write a for /while loop to get a final value. 
    #2. get values for NAs for days attended, 
    #3. get values so this can go into the whole mothership dataset. 
...
#3. Extract the valeues for each patient at their last day (length of stay)
 Mothership <- mutate(Mothership,
            # CUDOS_post = CUDOS_post)
            CUXOS_post = CUXOS_post)
